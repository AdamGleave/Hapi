...
% The two approaches I'm taking: approximation, and incremental.
% Link to Related Work / Challenges?
% First, discuss the flow solving algorithms themselves.
% Next, how they can be used in approximation and incremental mode.
% Not all algorithms applicable in all cases: will discuss further in performance profile.
