...
% Intro: Big it up. Something like: "Benchmarking a project of this scope is non-trivial, and requires considerable implementation. Although the details of the experiments conducted are in \cref{sec:eval}, this section gives some background on the implementation carried out."
