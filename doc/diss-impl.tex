...
% WORDCOUNT: Relaxation -- unsure whether to move the proofs for this section to appendix
...
% WORDCOUNT: Incremental choice of algorithms -- could probably cut why cycle cancelling doesn't work; maybe true for cost scaling, too.
...
%WORDCOUNT: Extending RelaxIV -- could probably make further cuts here
