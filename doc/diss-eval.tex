...
In practice, the algorithms developed in this project would be used as part of a larger cluster scheduling system. To demonstrate this capability, the flow solvers implemented in the project were integrated into the Firmament system. \Cref{fig:firmament-ui} shows the system in action, on a cluster of 14 machines.
...
%High-level points:
%
%* Simulator & Google trace
%* Test methodology
%* Benchmark suite
% High-level points
% Malte thought move test harness to this section. Can probably include the justification for testing at scale on a simulator, too.
