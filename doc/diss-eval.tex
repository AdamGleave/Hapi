...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{opt_ap_big_vs_small_relative}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{opt_ap_full_vs_partial_relative}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{opt_relax_arc_cache_relative}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{opt_cs_wave_vs_fifo_relative}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{opt_cs_scaling_factor}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{opt_parser_set_vs_getarc_relative}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{app_road_over_time}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{app_road_oracle_policy}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{app_road_policy_parameter_accuracy}
