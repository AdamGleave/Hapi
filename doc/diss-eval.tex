...
\begin{figure}
    \begin{widepage}
        ...
        \end{subfigure}
    \end{widepage}
    \caption{Selecting a cost threshold $c$. Key: {\color{1st_percentile} 1\textsuperscript{st} percentile}, {\color{5th_percentile} 5\textsuperscript{th} percentile}, {\color{25th_percentile} 25\textsuperscript{th} percentile}, {\color{median} median}.}
...
\begin{figure}
    \begin{widepage}
        ...
        \end{subfigure}
    \end{widepage}
    \caption{Speedup under cost convergence policy}
