...
Unlike with other algorithms, evaluation of approximate solution methods must consider not just its speed, but also its accuracy. To complicate matters further, both the speed and accuracy of the approximation algorithm will vary depending on the terminating condition chosen.
...
\subsection{Comparison with non-incremental, same type}
...
\subsection{Comparison with non-incremental, different type}
