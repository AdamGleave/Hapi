...
% Covered by: ap_big_vs_small_heap

\subsubsection{Vector vs map reverse index}

% Covered by: ap_big_vs_small_heap

\subsubsection{Terminating Djikstra early}

% Covered by: ap_full_vs_partial_djikstra

\subsection{Relaxation algorithm}

% OPT: Complete list

\subsubsection{Caching arcs crossing the cut}

% Covered by: relax_cache_arcs
...
% Covered by: cs_wave_fs_fifo

\subsubsection{Scaling factor}

% Covvered by: cs_scaling_factor
...
\subsubsection{Pruning zero capacity arcs}

% This is a bit trivial. Possibly best ignored.
% Covered by: parser_ignore_zero_capacity

\subsubsection{Set vs getArc}

% Maintain set of arcs that already exist, to speed lookup. This is a bit less trivial and has some interesting scope for data structures discussion, so perhaps worth using.

% Covered by: parser_set_vs_getarc
