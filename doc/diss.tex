...
\definecolor{1st_percentile}{HTML}{00008B}
\definecolor{5th_percentile}{HTML}{004225}
\definecolor{25th_percentile}{HTML}{AE0C00}
\definecolor{median}{HTML}{00FFFF}
...
\input{diss-csheuristics} 

%TODO: Restructure
\chapter{Benchmark harness}
\include{diss-tests}
