...
\node [draw, rectangle, blue] (m1) at (10.0,0.5) {M$_1$};
...
% Tasks to X
\path [draw, ->] (t00) -- node[below, sloped] {2} (x);
\path [draw, ->] (t01) -- node[below, sloped] {2} (x);
\path [draw, ->] (t10) -- node[below, sloped] {} (x);

% Tasks to U_i
\path [draw, ->] (t00) -- node[above, sloped] {5} (u0);
\path [draw, ->] (t01) -- node[above, sloped] {5} (u0);
\path [draw, ->] (t10) -- node[above, sloped] {0} (u1);
...
\path [draw, ->, dotted, red] (t01) edge[out=-30, in=180, looseness=1] node[above, sloped] {1} (m1);

% preference edge
\path [draw, ->, dashed] (t10) edge[in=180, out=-15, looseness=0.8] node[above, sloped] {$5$} (m1);
