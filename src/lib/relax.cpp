...
RELAX::cut_arcs_iterator::cut_arcs_iterator(const RELAX &algo) : algo(algo) {
...
RELAX::cut_arcs_iterator::cut_arcs_iterator(const RELAX &algo, bool) : algo(algo) {
  // end sentinel
...
RELAX::cut_arcs_iterator RELAX::beginCutArcs() const {
  return cut_arcs_iterator(*this);
}

RELAX::cut_arcs_iterator RELAX::endCutArcs() const {
