...
DATASET_ROOT = os.path.join(SOURCE_ROOT, "graphs")
EXECUTABLE_DIR = os.path.join(BUILD_ROOT, "bin")
EXECUTABLE_SRC_DIR = os.path.join(SOURCE_ROOT, "bin")

### Goldberg's CS2 solver
# Known-working reference implementation
REFERENCE_PROGRAM_PATH = os.path.join(BUILD_ROOT, "cs2", "cs2")
